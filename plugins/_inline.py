...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="t.me/link_buyer"),
        Button.url("• Support •", url="t.me/NobitaLoger"),
    ],
]
...
async def inline_alive(o):
    TLINK = inline_pic() or "https://i.ibb.co/d0mw6f8g/x.jpg"
    MSG = "• **Nobita Userbot •**"
    WEB0 = InputWebDocument(
        "https://i.ibb.co/d0mw6f8g/x.jpg", 0, "image/jpg", []
    )
    RES = [
